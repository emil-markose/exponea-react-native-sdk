...
export default function AuthScreen(props: AuthScreenProps): React.ReactElement {
  const [projectToken, setProjectToken] = React.useState('be6dded0-509c-11ef-9c45-a2de66e48099');
  const [authorization, setAuthorization] = React.useState('i6ugnfbwc2j8ck8306gfpho2wbtsxffa98n50jbetf2o3ddqc9xf2088q2uvcfdv');
  const [advancedAuthKey, setAdvancedAuthKey] = React.useState('');
  const [baseUrl, setBaseUrl] = React.useState('https://crm-api.aspireglobal.com');
